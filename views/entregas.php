...
<body>
    ...
    <div id="formularioModal">
        ...
        <form method="post" action="entregas.php">
            ...
            <input id="endereco" type="text" name="endereco" required placeholder="Endereço" style="margin:5px 0;width:90%;border-radius:5px;padding:6px">

            <!-- Latitude e Longitude serão preenchidas automaticamente -->
            <input id="lat" type="text" name="lat" required placeholder="Latitude" readonly style="margin:5px 0;width:90%;border-radius:5px;padding:6px;background:#f5f5f5;">
            <input id="lng" type="text" name="lng" required placeholder="Longitude" readonly style="margin:5px 0;width:90%;border-radius:5px;padding:6px;background:#f5f5f5;">
        ...
        <script>
            function initAutocomplete() {
                ...
                autocomplete.addListener("place_changed", () => {
                    ...
                    // Preenche lat e lng automaticamente
                    document.getElementById("lat").value = place.geometry.location.lat();
                    document.getElementById("lng").value = place.geometry.location.lng();
                });
            }

            // Inicializa autocomplete quando a página carregar
            ...
            formEntregador.addEventListener('submit', function(e) {
                const nums = telefoneInput.value.replace(/\D/g, ''); // só números
                if (nums.length !== 11) {
